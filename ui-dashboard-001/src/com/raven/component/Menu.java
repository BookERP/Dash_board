...
public class Menu extends javax.swing.JPanel {
    ...
    private void init() {
        listMenu1.addItem(new Model_Menu("1", "대시 보드", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("2", "고객 관리", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("3", "상품 관리", Model_Menu.MenuType.MENU));
        ...
        listMenu1.addItem(new Model_Menu("1", "Extra", Model_Menu.MenuType.MENU));
